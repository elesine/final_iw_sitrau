...
class ShiftsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'turno: maniana, tarde, noche', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'name' => 'Lorem ip',
                'status' => 1,
                'created' => '2020-05-23 01:59:47',
                'modified' => '2020-05-23 01:59:47',
            ],
        ];
        parent::init();
    }
