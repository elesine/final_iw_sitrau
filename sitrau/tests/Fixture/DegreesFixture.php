...
class DegreesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'Grado academico', 'precision' => null, 'fixed' => null],
        'acronym' => ['type' => 'string', 'length' => 10, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'Abreviatura', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'acronym' => 'Lorem ip',
                'status' => 1,
                'created' => '2020-05-23 01:56:21',
                'modified' => '2020-05-23 01:56:21',
            ],
        ];
        parent::init();
    }
