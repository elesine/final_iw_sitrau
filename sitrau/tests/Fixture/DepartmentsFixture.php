...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'departments_ibfk_1' => ['type' => 'foreign', 'columns' => ['faculty_id'], 'references' => ['faculties', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'faculty_id' => 1,
                'status' => 1,
                'created' => '2020-05-23 01:57:04',
                'modified' => '2020-05-23 01:57:04',
            ],
        ];
        parent::init();
    }
