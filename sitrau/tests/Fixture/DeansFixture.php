...
class DeansFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'faculty_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'faculty_key' => ['type' => 'index', 'columns' => ['faculty_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'deans_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'deans_ibfk_2' => ['type' => 'foreign', 'columns' => ['degree_id'], 'references' => ['degrees', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'deans_ibfk_3' => ['type' => 'foreign', 'columns' => ['faculty_id'], 'references' => ['faculties', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'faculty_id' => 1,
                'status' => 1,
                'created' => '2020-05-23 01:56:52',
                'modified' => '2020-05-23 01:56:52',
            ],
        ];
        parent::init();
    }
