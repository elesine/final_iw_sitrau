...
class FacultiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'faculties_ibfk_1' => ['type' => 'foreign', 'columns' => ['university_id'], 'references' => ['universities', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'university_id' => 1,
                'status' => 1,
                'created' => '2020-05-23 01:56:44',
                'modified' => '2020-05-23 01:56:44',
            ],
        ];
        parent::init();
    }
