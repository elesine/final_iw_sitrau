...
class SchoolsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'schools_ibfk_1' => ['type' => 'foreign', 'columns' => ['department_id'], 'references' => ['departments', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'department_id' => 1,
                'status' => 1,
                'created' => '2020-05-23 01:57:31',
                'modified' => '2020-05-23 01:57:31',
            ],
        ];
        parent::init();
    }
